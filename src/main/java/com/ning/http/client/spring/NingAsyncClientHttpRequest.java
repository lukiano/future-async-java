...
public class NingAsyncClientHttpRequest extends PublicAbstractBufferingAsyncClientHttpRequest {
    ...
    protected ListenableFuture<ClientHttpResponse> executeInternal(HttpHeaders headers, byte[] bufferedOutput) throws IOException {
        ...
        com.ning.http.client.ListenableFuture<Response> ningResponse = boundRequestBuilder.execute();
    ...
    public static final class NingListenableFutureToSpringListenableFuture<T> implements ListenableFuture<T> {
        ...
        public NingListenableFutureToSpringListenableFuture(com.ning.http.client.ListenableFuture<T> future) {
            this.future = future;
        }
